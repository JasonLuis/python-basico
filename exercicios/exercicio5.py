...
def recebeCelcius():
  celcius = int(input("Informe o valor da temperatura: "))
  return celcius

def converterFahrenheit(celcius):
  fahrenheit = (9 * celcius + 160)/5
  return fahrenheit

def imprimeResultado(fahrenheit):
  print("Fahrenheit: ",fahrenheit)


celcius = recebeCelcius()

fahrenheit = converterFahrenheit(celcius)
imprimeResultado(fahrenheit)
...
def recebeValores():
  ...
  velocidade = int(input("Informe a velocidade média em Km: "))
...
def calcularQtdLitros(distancia):
  litros = distancia / 12
  return litros

def mostrarResultado(tempo, velocidade, distancia, litros):
  print("Tempo de viagem: ",tempo)
  print("Velocidade média de percurso: ",velocidade)
  print("Distancia percorrida: ",distancia)
  print("Quantidade de litros gasto: ",litros)

tempo, velocidade = recebeValores()

distancia = calcularDistancia(tempo, velocidade)

litros = calcularQtdLitros(distancia)

mostrarResultado(tempo, velocidade, distancia, litros)